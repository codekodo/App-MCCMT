...
function AddHtmlToPopupBox(Type) {
	...
	if(Type=='answer')
	{
		...
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'7\')"><b>7</b></a>';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'8\')"><b>8</b></a>';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'9\')"><b>9</b></a><br />';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'4\')"><b>4</b></a>';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'5\')"><b>5</b></a>';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'6\')"><b>6</b></a><br />';   
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'1\')"><b>1</b></a>';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'2\')"><b>2</b></a>';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'3\')"><b>3</b></a><br />';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'0\')"><b>0</b></a>';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie_box(\'.\')"><b>,</b></a>';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:31%" href="#" role="button" onclick="saisie(\' \')"><b>&#9251; </b></a><br />';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:47%" href="#" role="button" onclick="back()"><b><</b></a>';
		Content += '<a class="btn btn-default" style="margin:1%;height:45px;width:48%" href="#" role="button" onclick="reset()"><b>C</b></a>';
